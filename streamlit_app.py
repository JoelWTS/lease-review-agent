...
first_review_date
= first rent review date in the lease.

review_frequency
= frequency of reviews.

review_mechanism
= doubling, RPI, CPI, fixed increase etc.

next_future_review_date
= next review date after today.

who_insures
= landlord, management company, tenant etc.

insurance_payment_position
= who actually pays and whether it is recharged.

insurance_admin_fee_available
= can landlord charge an admin fee or management fee in relation to insurance recoveries.

insurance_commission_allowed
= can landlord retain insurance commission.

evidence
= page numbers and clause references.
